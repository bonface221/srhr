...
const EventsListing = () => {
  return (
    <Stack marginX={marginX} my="4rem" gap="4rem">
      ...
      {true ? (
        <Box>
          <Text fontWeight={700} fontSize="xl" color="red.400">
          ...
          >
            ...
            <GridItem display="flex" flexDir="column" gap={4}>
              ...
              <Text>
                ...
                Debitis dolore mollitia officia saepe? Animi dolore, iure illum
                fuga et quis ab est. Maxime nihil laboriosam fuga adipisci
                laborum harum. Aliquid!
              </Text>
